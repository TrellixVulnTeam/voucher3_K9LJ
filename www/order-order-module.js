...
/* harmony import */ var firebase_auth__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! firebase/auth */ "6nsN");
...
let OrderPage = class OrderPage {
    constructor(nav, modal, toastController, title, routerOutlet, alertController, actRoute, platform, iab, http) {
        this.nav = nav;
        this.modal = modal;
