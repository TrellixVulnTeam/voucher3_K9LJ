...
let HomePage = class HomePage {
    ...
    ionViewDidEnter() {
        ...
        firebase_app__WEBPACK_IMPORTED_MODULE_4__["default"].database().ref('users/' + this.user).once('value', data => {
    ...
    fpx() {
        ...
        let keyer = firebase_app__WEBPACK_IMPORTED_MODULE_4__["default"].database().ref('orders_pending').push({
            ...
            price_comm: this.voucher.price_comm || 0,
            price_now: ((this.voucher.price_now + this.countvar())) || 0,
            price_ori: this.voucher.price_ori || 0,
            qty: this.qty || 1,
        ...
        let body = {
            amount: ((this.voucher.price_now + this.countvar()) * this.qty) * 100,
            orderdescription: 'Purchase ' + this.items.name + ' x' + (this.qty || 1),
            ordertitle: 'Vsnap Sales Order Payment',
            orderid: keyer,
        };
        //     orderid
        // ordertitle
        ...
        if (this.email && this.name) {
            this.http.post('https://us-central1-newvsnap.cloudfunctions.net/revenueMonsterPayment', body).subscribe(a => {
    ...
    free() {
        ...
        if (this.email && this.name) {
            ...
            firebase_app__WEBPACK_IMPORTED_MODULE_4__["default"].database().ref('orders/' + ids).update({
                ...
                // console.log(2);
                this.nav.navigateForward('thanks?billplz[paid]=true&orderid=' + ids);
            });
        }
        else {
            sweetalert__WEBPACK_IMPORTED_MODULE_11___default()({
